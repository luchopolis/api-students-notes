...
export type StorageHash =
  StorageHashBase<'2004c6f044ba64649deebe70df7f3bdb55594efd0f2e38e95b6b9b023133b2d9'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PeriodFile: {
      ...
      readonly generatedAt: TimestamptzString<3>;
    };
    readonly Student: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      ...
      readonly birthDate: CodecTypes['pg/date-string@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Student: {
      ...
      readonly gender: 'F' | 'M' | null;
      readonly birthDate: CodecTypes['pg/date-string@1']['input'] | null;
...
export namespace Models {
  ...
  export type public_Period = {
    ...
    files: public_PeriodFile[];
    readonly [RelationKeys]?: 'academicYear' | 'evaluations' | 'files';
  };
  export type public_PeriodFile = {
    id: CodecTypes['pg/uuid@1']['output'];
    ...
    generatedAt: TimestamptzString<3>;
    period: public_Period;
    subject: public_Subject;
    readonly [RelationKeys]?: 'period' | 'subject';
  };
  export type public_Student = {
    ...
    gender: 'F' | 'M' | null;
    birthDate: CodecTypes['pg/date-string@1']['output'] | null;
  ...
  export type public_Subject = {
    ...
    enrollments: public_Enrollment[];
    periodFiles: public_PeriodFile[];
    readonly [RelationKeys]?: 'activities' | 'enrollments' | 'periodFiles';
  };
...
export declare const models: {
  public: {
    ...
    PeriodFile: Models.public_PeriodFile;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly period_files: {
              ...
              indexes: readonly [
                {
                  readonly name: 'period_files_periodId_subjectId_generatedAt_idx_ff91f835';
                  readonly prefix: 'period_files_periodId_subjectId_generatedAt_idx';
                  readonly columns: readonly ['periodId', 'subjectId', 'generatedAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'period_files_periodId_idx_f0176b8a';
                  readonly prefix: 'period_files_periodId_idx';
                  readonly columns: readonly ['periodId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'period_files_subjectId_idx_84df2a1d';
                  readonly prefix: 'period_files_subjectId_idx';
                  readonly columns: readonly ['subjectId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'period_files';
                    readonly columns: readonly ['periodId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
